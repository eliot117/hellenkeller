...
<head>
    ...
    <title>Panel Administrativo HellenKeller</title>
    <!-- CKeditor 4-->
    ...
    <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full" data-boxed-layout="full">
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <div class="navbar-brand">
                        <a href="{{ route('home') }}" class="logo">
                            <!-- Logo icon -->
                            <b class="logo-icon" style="color: white;">
                                Colegio HellenKeller
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item search-box">
                            ...
                            <form class="app-search position-absolute">
                                <input type="text" class="form-control" placeholder="Buscar &amp; Presione Enter">
                                <a class="srh-btn">
                                    <i class="ti-close"></i>
                                </a>
                            </form>
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{ asset('storage/avatar/'.Auth::user()->avatar) }} " class="rounded-circle" width="31">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="javascript:void(0)"><i class="ti-user m-r-5 m-l-5"></i> Mi Perfil</a>
                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal"><i class="mdi mdi-logout-variant m-r-5 m-l-5"></i> Cerrar Sesión</a>
                            </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="starter-kit.html" aria-expanded="false">
                                ...
                                <span class="hide-menu">Carrusel</span>
                            </a>
                        </li>
                        <!--<li class="sidebar-item">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                Copyright © Panel Administrativo HellenKeller 2020
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
